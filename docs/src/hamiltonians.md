...
The Hamiltonians can be used for projector quantum Monte Carlo with [`FCIQMCProblem`](@ref) or for exact diagonalization with [`ExactDiagonalizationProblem`](@ref), see [Exact Diagonalization](#Exact-Diagonalization).
