...
bfs2 = BoseFS(bs2)
bfs3 = BoseFS(bs3)
bfs4 = nearUniform(BoseFS{128,80}) # needs 4 chunks
bfs5 = nearUniform(BoseFS{128,135}) # needs 5 chunks
bfs6 = nearUniform(BoseFS{128,250}) # needs 6 chunks
bfs7 = nearUniform(BoseFS{200,200})
